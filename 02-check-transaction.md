...
This API allow you to get the transaction status of a transaction, you can only check the transaction that created within 7 days only.
...
**Rate Limit**: Request limit 600 requests/second
